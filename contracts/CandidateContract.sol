...
contract CandidateContract is AccessControl, CandidateStructure {
    ...
    // function castVotePresident( string memory _presidentRegNo, address _voterContractAddress) public {
    ...
    // }
    // function castVoteGovernor( string memory _governorRegNo, address _voterContractAddress ) public {
    //     VoterContract vc = VoterContract(_voterContractAddress);
    //     require(vc.getVoter(msg.sender).isRegistered, "Voter is not registered");
    ...
    // function castVoteBlockLeader( string memory _blockLeaderRegNo, address _voterContractAddress ) public {
    //     VoterContract vc = VoterContract(_voterContractAddress);
    //     require(vc.getVoter(msg.sender).isRegistered, "Voter is not registered");    
