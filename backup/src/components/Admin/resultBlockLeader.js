...
const ResultBlockLeader = (props) => {
  ...
  const handleRegisterVoter = async (event) => {
    try{
      ...
      await contract.methods.registerBlockLeader(firstName, lastName, college, program, yearOfStudy, regNo, blockNumber, gender).send({ from: selectedAccount, gas: 1000000 });
