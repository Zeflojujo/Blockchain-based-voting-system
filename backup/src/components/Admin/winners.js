          ...
          <Container maxWidth="lg" sx={{ mt: isXs || isSm ? 2 : isMd ? 4 : 6, mb: isXs || isSm ? 2 : isMd ? 4 : 6 }}>
            ...
            <Grid item xs={12}>
              ...
              > 
                  ...
                  {winnerCandidate.map((block, index) => (
                    <div key={index}>
                      <div>{block.firstName}</div>
                      <div>{block.regNo}</div>
                      <div>{block.collegeName}</div>
                      <div>{block.programName}</div>
                      <div>{block.voteCount}</div>
                    </div>
