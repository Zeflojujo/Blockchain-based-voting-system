...
const Phase = (props) => {
  ...
  const calculateTime = (e) => {
    ...
    const starttime = (parseInt(startDay) * 60*60*24) + (parseInt(startHour) * 60 * 60) + (parseInt(startMinute) * 60) + parseInt(startSecond);
    const endtime = (parseInt(endDay) * 60*60*24) + (parseInt(endHour) * 60 * 60) + (parseInt(endMinute) * 60) + parseInt(endSecond);
  ...
  const handleRegisterVotingTime = async (event) => {
    ...
    try{
      ...
      await contracts.methods.setVotingPeriod(startTime, endTime).send({ from: selectedAccount, gas: 1000000 });
                            ...
                            <label><h2>Set Start Voting Time</h2></label>
                              <div>
                                ...
                                <TextField                                 
                                  ...
                                  onBlur={formik.handleBlur}
                                  error={formik.touched.startSecond && Boolean(formik.errors.startSecond)}
                                  helperText={formik.touched.startSecond && formik.errors.startSecond}
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <TextField                                 
                                  ...
                                  onBlur={formik.handleBlur}
                                  error={formik.touched.endSecond && Boolean(formik.errors.endSecond)}
                                  helperText={formik.touched.endSecond && formik.errors.endSecond}
                                />
                              </div>
