  ...
  const handleClose = () => {
    ...
    const handleRegisterPresident = async (event) => {
      try{
        ...
        await contract.methods.registerPresident(firstName, lastName, college, program, yearOfStudy, regNo, blockNumber, vAddress).send({ from: selectedAccount, gas: 1000000 });
