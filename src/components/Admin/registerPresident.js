...
const RegisterPresident = (props) => {
  ...
  const handleRegisterVoter = async (event) => {
    ...
    await contracts.methods.registerPresident(name, college, program, yearOfStudy, regNo, blockNumber, gender).send({ from: accountss[0], gas: 1000000 });
  }
